...
| 해외 사고 시 혼란 | 필요 서류·연락처를 몰라 당황하는 경우 多 |
...
> 이 저장소는 **PDF 업로드 → AI 자동 파싱 → 보장 항목 구조화** 파이프라인을 담당합니다.
...
- 전체 서비스 레포지토리: [capstone-polight (준비 중)]()
- Finnect 공모전: [https://www.finnect.co.kr](https://www.finnect.co.kr)
